...
<section class="modulo-four <?php if(get_field('invertir')){ echo 'invertida'; }?> f-<?php echo get_field('diseno')['fondo']; ?>" style="background-image: url('<?php echo get_field('fondo')['fondo']['url']; ?>')">
