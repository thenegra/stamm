...
<section class="modulo-facilities-map new-modules <?php if(get_field('invertir')){ echo 'invertida'; }?> f-<?php echo get_field('diseno')['fondo']; ?>" id="<?php echo get_field('block_slug'); ?>">
	<?php getBlockHeader(); ?>
		<!-- Header provisorio -->
